package com.notificationprocessor.notificationprocessor.MessengerService.respuesta;
...
@Configuration
public class MessageRespuestaSenderBroker implements MessageSender<String> {
    ...
    public MessageRespuestaSenderBroker(RabbitTemplate rabbitTemplate, MapperJsonObjeto mapperJsonObjeto) {
    ...
    private Optional<org.springframework.amqp.core.Message> obtenerCuerpoMensaje(Object mensaje, MessageProperties propiedadesMensaje) {
    ...
    @Override
    public void execute(String message, String exchange, String routingKey, String idMessage) {
